...
export class UserPreferencesDto {
  @ApiProperty({ enum: ['beginner', 'expert'], description: 'Niveau de difficulté préféré', example: 'beginner' })
  declare difficulty: string

  @ApiProperty({ type: [String], description: 'Langages de programmation préférés', example: ['TypeScript', 'Python'] })
...
export class UserDto {
  ...
  @ApiPropertyOptional({ nullable: true, description: "URL de l'avatar GitHub", example: 'https://avatars.githubusercontent.com/u/123456' })
  ...
  @ApiPropertyOptional({ nullable: true, type: () => UserPreferencesDto, description: 'Préférences du fil de projets' })
  declare preferences: UserPreferencesDto | null

  @ApiProperty({ description: 'Horodatage de création ISO 8601', example: '2024-01-01T00:00:00.000Z' })
  declare createdAt: string

  @ApiProperty({ description: 'Horodatage de dernière modification ISO 8601', example: '2024-01-01T00:00:00.000Z' })
...
export class UpdatePreferencesBodyDto {
  ...
  @ApiProperty({ type: [String], description: 'Au moins un langage de programmation', example: ['TypeScript', 'Python'] })
  declare languages: string[]
}
