...
export class ShowcaseContributorDto {
  ...
  @ApiProperty({ description: "URL de l'avatar GitHub", example: 'https://avatars.githubusercontent.com/u/1024025' })
...
export class ShowcaseProjectDto {
  ...
  @ApiPropertyOptional({ nullable: true, description: 'Tag de la dernière version', example: 'v6.12' })
  declare latestRelease: string | null

  @ApiPropertyOptional({ nullable: true, description: 'Horodatage de dernière modification ISO 8601', example: '2024-01-01T00:00:00.000Z' })
  declare updatedAt: string | null

  @ApiProperty({ type: [String], description: 'Sujets du dépôt', example: ['kernel', 'linux', 'os'] })
  declare topics: string[]

  @ApiPropertyOptional({ nullable: true, description: 'Nombre total de contributeurs', example: 25000 })
...
export class ShowcaseResponseDto {
  @ApiProperty({ type: () => [ShowcaseLanguageResultDto], description: 'Projets regroupés par langage' })
...
export class ProjectDto {
  ...
  @ApiPropertyOptional({ nullable: true, type: [String], description: 'Sujets du dépôt', example: ['nodejs', 'framework'] })
  declare topics: string[] | null

  @ApiProperty({ description: "Nombre d'issues ouvertes", example: 42 })
  declare openIssuesCount: number

  @ApiProperty({ enum: ['beginner', 'expert'], description: 'Niveau de difficulté', example: 'beginner' })
  declare difficulty: string

  @ApiProperty({ description: 'Nombre de forks', example: 850 })
  declare forksCount: number

  @ApiPropertyOptional({ nullable: true, description: 'Nombre total de contributeurs', example: 180 })
  declare totalContributorsCount: number | null

  @ApiPropertyOptional({ nullable: true, description: 'Tag de la dernière version', example: 'v6.1.0' })
  declare latestRelease: string | null

  @ApiPropertyOptional({ nullable: true, description: 'README au format Markdown' })
  declare readme: string | null

  @ApiPropertyOptional({ nullable: true, description: 'Répartition des langages en octets', example: { TypeScript: 145000, JavaScript: 3200 } })
  ...
  @ApiPropertyOptional({ nullable: true, description: 'Horodatage ISO 8601 du dernier chargement des détails GitHub', example: '2024-01-01T00:00:00.000Z' })
  declare detailsFetchedAt: string | null

  @ApiPropertyOptional({ nullable: true, description: 'Horodatage de création ISO 8601', example: '2024-01-01T00:00:00.000Z' })
...
export class ContributorDetailDto {
  ...
  @ApiProperty({ description: "URL de l'avatar", example: 'https://avatars.githubusercontent.com/u/789' })
  declare avatarUrl: string
  ...
  @ApiPropertyOptional({ nullable: true, description: "Identifiant numérique interne GitHub de l'utilisateur", example: 789123 })
...
export class FeedResponseDto {
  ...
  @ApiProperty({ description: 'Nombre de projets non vus correspondant aux préférences', example: 243 })
...
export class InteractionResponseDto {
  @ApiProperty({ enum: ['liked', 'passed'], description: "Type d'interaction enregistré", example: 'liked' })
  declare type: string
}
