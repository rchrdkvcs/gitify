...
export interface Registry {
  ...
  'project.liked': {
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/project_controller').default['liked']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/project_controller').default['liked']>>>
    }
  }
  'project.show': {
    methods: ["GET","HEAD"]
