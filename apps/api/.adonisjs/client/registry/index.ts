...
const routes = {
  ...
  "auth.redirect": {
    ...
    tokens: [
      { old: "/auth/github/redirect", type: 0, val: "auth", end: "" },
      { old: "/auth/github/redirect", type: 0, val: "github", end: "" },
      { old: "/auth/github/redirect", type: 0, val: "redirect", end: "" },
    ],
  ...
  "auth.callback": {
    ...
    tokens: [
      { old: "/auth/github/callback", type: 0, val: "auth", end: "" },
      { old: "/auth/github/callback", type: 0, val: "github", end: "" },
      { old: "/auth/github/callback", type: 0, val: "callback", end: "" },
    ],
  ...
  "auth.me": {
    ...
    pattern: "/auth/me",
    tokens: [
      { old: "/auth/me", type: 0, val: "auth", end: "" },
      { old: "/auth/me", type: 0, val: "me", end: "" },
    ],
  ...
  "preferences.update": {
    ...
    tokens: [
      { old: "/auth/preferences", type: 0, val: "auth", end: "" },
      { old: "/auth/preferences", type: 0, val: "preferences", end: "" },
    ],
  ...
  "project.showcase": {
    ...
    tokens: [
      { old: "/projects/showcase", type: 0, val: "projects", end: "" },
      { old: "/projects/showcase", type: 0, val: "showcase", end: "" },
    ],
  ...
  "project.feed": {
    ...
    tokens: [
      { old: "/projects/feed", type: 0, val: "projects", end: "" },
      { old: "/projects/feed", type: 0, val: "feed", end: "" },
    ],
  ...
  "project.show": {
    ...
    pattern: "/projects/:id",
    tokens: [
      { old: "/projects/:id", type: 0, val: "projects", end: "" },
      { old: "/projects/:id", type: 1, val: "id", end: "" },
    ],
