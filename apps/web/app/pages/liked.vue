  ...
  <div class="min-h-screen bg-gray-900 p-8 text-white">
    <div class="mx-auto max-w-2xl">
      <div class="mb-8 flex items-center justify-between">
        ...
        <NuxtLink to="/swipe" class="rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold transition hover:bg-blue-700">
          ← Retour au swipe
        </NuxtLink>
      </div>

      <div v-if="loading" class="animate-pulse text-center text-gray-400">
        Chargement...
      </div>
      ...
      <div v-else class="space-y-4">
        ...
        >
          ...
          <div class="mb-3 flex flex-wrap gap-2">
            <span v-if="project.language" class="rounded-full bg-blue-900/50 px-3 py-1 text-xs font-medium text-blue-300">
              {{ project.language }}
            </span>
            <span class="rounded-full bg-yellow-900/50 px-3 py-1 text-xs font-medium text-yellow-300">
